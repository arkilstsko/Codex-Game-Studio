# Codex Game Studio -- Game Studio Agent Architecture
...
@codex-studio/docs/coordination-rules.md
...
> run `$ccgs-start` to begin the guided onboarding flow.

## Coding Standards

@codex-studio/docs/coding-standards.md
