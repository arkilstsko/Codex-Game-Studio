...
description: "Codex Game Studio workflow `/reverse-document`. Use when the user asks for CCGS game-studio workflow `ccgs-reverse-document` or the original `/reverse-document` command. Generate design or architecture documents from existing implementation. Works backwards from code/prototypes to create missing planning docs."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `reverse-document`.
