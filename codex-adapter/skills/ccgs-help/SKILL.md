---
name: ccgs-help
description: "Codex Game Studio workflow `/help`. Use when the user asks for CCGS game-studio workflow `ccgs-help` or the original `/help` command. Analyzes what is done and the users query and offers advice on what to do next. Use if user says what should I do next or what do I do now or I'm stuck or I don't know what to do"
---

## Codex Adapter

This is the Codex Game Studio workflow skill `help`.
...
Read `~/.codex/skills/ccgs-references/references/docs/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, Glob `~/.codex/skills/ccgs-references/references/source-skills/*/SKILL.md` to get the full list
