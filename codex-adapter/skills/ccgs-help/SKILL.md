...
Read `../ccgs-references/references/docs/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, Glob `../ccgs-references/references/source-skills/*/SKILL.md` to get the full list
