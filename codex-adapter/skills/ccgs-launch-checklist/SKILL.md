...
description: "Codex Game Studio workflow `/launch-checklist`. Use when the user asks for CCGS game-studio workflow `ccgs-launch-checklist` or the original `/launch-checklist` command. Complete launch readiness validation covering every department: code, content, store, marketing, community, infrastructure, legal, and go/no-go sign-offs."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `launch-checklist`.
