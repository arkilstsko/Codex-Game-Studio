...
| **References Consulted** | [engine-reference docs read before writing this — e.g. `~/.codex/skills/ccgs-references/references/docs/engine-reference/godot/modules/physics.md`] |
