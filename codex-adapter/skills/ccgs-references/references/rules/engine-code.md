...
- Before writing engine API code, consult `~/.codex/skills/ccgs-references/references/docs/engine-reference/` for the current engine version and verify APIs against the reference docs
