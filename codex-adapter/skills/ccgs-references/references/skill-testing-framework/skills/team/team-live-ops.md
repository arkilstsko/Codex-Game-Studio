...
4. request_user_input presented with resolution options before season plan approval is offered
...
- [ ] request_user_input is used to surface the violation and offer resolution options (revise economy design, override with documented rationale, cancel)
