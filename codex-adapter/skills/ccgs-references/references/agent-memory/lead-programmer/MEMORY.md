...
### File Layout
- Skills live in `~/.codex/skills/ccgs-references/references/source-skills/<name>/SKILL.md` (subdirectory per skill, never flat .md)
...
- Engine reference: `~/.codex/skills/ccgs-references/references/docs/engine-reference/[engine]/VERSION.md`
