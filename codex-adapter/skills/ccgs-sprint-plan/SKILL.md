...
Before finalising the sprint plan, load the `producer` role reference and perform that role pass using gate **PR-SPRINT** (`../ccgs-references/references/docs/director-gates.md`).
