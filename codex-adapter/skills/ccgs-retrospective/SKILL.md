...
description: "Codex Game Studio workflow `/retrospective`. Use when the user asks for CCGS game-studio workflow `ccgs-retrospective` or the original `/retrospective` command. Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and patterns. Produces actionable insights for the next iteration."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `retrospective`.
...
If a matching file is found, use `request_user_input`:
