...
description: "Codex Game Studio workflow `/team-combat`. Use when the user asks for CCGS game-studio workflow `ccgs-team-combat` or the original `/team-combat` command. Orchestrate the combat team: coordinates game-designer, gameplay-programmer, ai-programmer, technical-artist, sound-designer, and qa-tester to design, implement, and validate a combat feature end-to-end."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `team-combat`.
...
- **engine specialist** (primary) — Validate architecture and implementation patterns are idiomatic for the engine (read from `~/.codex/skills/ccgs-references/references/docs/technical-preferences.md` Engine Specialists section)
...
- `role: [primary engine specialist]` — Engine idiom validation for architecture and implementation
