...
description: "Codex Game Studio workflow `/perf-profile`. Use when the user asks for CCGS game-studio workflow `ccgs-perf-profile` or the original `/perf-profile` command. Structured performance profiling workflow. Identifies bottlenecks, measures against budgets, and generates optimization recommendations with priority rankings."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `perf-profile`.
