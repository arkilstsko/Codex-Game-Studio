...
description: "Codex Game Studio workflow `/skill-test`. Use when the user asks for CCGS game-studio workflow `ccgs-skill-test` or the original `/skill-test` command. Validate skill files for structural compliance and behavioral correctness. Three modes: static (linter), spec (behavioral), audit (coverage report)."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `skill-test`.
