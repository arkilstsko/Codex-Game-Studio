---
name: ccgs-changelog
description: "Codex Game Studio workflow `/changelog`. Use when the user asks for CCGS game-studio workflow `ccgs-changelog` or the original `/changelog` command. Auto-generates a changelog from git commits, sprint data, and design documents. Produces both internal and player-facing versions."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `changelog`.
