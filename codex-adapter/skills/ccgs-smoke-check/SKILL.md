...
1. **Test framework check**: verify `tests/` directory exists.
   If it does not: "No test directory found at `tests/`. Run `$ccgs-test-setup`
...
Use `request_user_input` to batch-verify. Keep to at most 3 calls.
