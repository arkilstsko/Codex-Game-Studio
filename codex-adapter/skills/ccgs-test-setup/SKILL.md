...
description: "Codex Game Studio workflow `/test-setup`. Use when the user asks for CCGS game-studio workflow `ccgs-test-setup` or the original `/test-setup` command. Scaffold the test framework and CI/CD pipeline for the project's engine. Creates the tests/ directory structure, engine-specific test runner configuration, and GitHub Actions workflow. Run once during Technical Setup phase before the first sprint begins."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `test-setup`.
