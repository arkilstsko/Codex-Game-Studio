...
description: "Codex Game Studio workflow `/create-architecture`. Use when the user asks for CCGS game-studio workflow `ccgs-create-architecture` or the original `/create-architecture` command. Guided, section-by-section authoring of the master architecture document for the game. Reads all GDDs, the systems index, existing ADRs, and the engine reference library to produce a complete architecture blueprint before any code is written. Engine-version-aware: flags knowledge gaps and validates decisions against the pinned engine version."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `create-architecture`.
