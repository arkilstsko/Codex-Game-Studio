...
description: "Codex Game Studio workflow `/bug-report`. Use when the user asks for CCGS game-studio workflow `ccgs-bug-report` or the original `/bug-report` command. Creates a structured bug report from a description, or analyzes code to identify potential bugs. Ensures every bug report has full reproduction steps, severity assessment, and context."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `bug-report`.
