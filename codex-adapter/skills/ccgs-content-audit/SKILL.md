...
description: "Codex Game Studio workflow `/content-audit`. Use when the user asks for CCGS game-studio workflow `ccgs-content-audit` or the original `/content-audit` command. Audit GDD-specified content counts against implemented content. Identifies what's planned vs built."
---

## Codex Adapter

This is the Codex Game Studio workflow skill `content-audit`.
