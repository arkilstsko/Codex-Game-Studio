...
After categorising findings, load the `creative-director` role reference and perform that role pass using gate **CD-PLAYTEST** (`~/.codex/skills/ccgs-references/references/docs/director-gates.md`).
