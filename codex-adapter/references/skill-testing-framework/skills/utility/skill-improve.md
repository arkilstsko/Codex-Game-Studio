...
4. Skill asks "May I write improvements to `codex-studio/skills/some-skill/SKILL.md`?"
...
**Fixture:**
- `codex-studio/skills/some-skill/SKILL.md` has 1 static failure (missing handoff)
...
**Fixture:**
- `codex-studio/skills/gate-check/SKILL.md` is a gate skill with 1 static failure
...
4. "May I write improvements to `codex-studio/skills/gate-check/SKILL.md`?"
...
**Fixture:**
- `codex-studio/skills/brainstorm/SKILL.md` has no static failures
