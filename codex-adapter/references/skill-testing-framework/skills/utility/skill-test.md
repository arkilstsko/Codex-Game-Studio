...
- **audit**: Produces a coverage table of all skills in `codex-studio/skills/` and
  all agents in `codex-studio/agents/`, showing which have spec files and which do not.
...
**Fixture:**
- `codex-studio/skills/brainstorm/SKILL.md` exists and is well-formed:
...
**Expected behavior:**
1. Skill reads `codex-studio/skills/brainstorm/SKILL.md`
...
- `codex-studio/skills/gate-check/SKILL.md` exists
...
**Fixture:**
- `codex-studio/skills/` contains 72+ skill directories
- `codex-studio/agents/` contains 49+ agent files
- `tests/skills/` contains spec files for a subset of skills

**Input:** `/skill-test audit`

**Expected behavior:**
1. Skill enumerates all skills in `codex-studio/skills/` and all agents in `codex-studio/agents/`
...
- `codex-studio/skills/gate-check/SKILL.md` is a gate skill
