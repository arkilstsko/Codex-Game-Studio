...
Read `AGENTS.md` and `codex-studio/docs/technical-preferences.md` for the engine and
language in use.
...
Read `codex-studio/docs/templates/prototype-report.md` to get the report structure.
