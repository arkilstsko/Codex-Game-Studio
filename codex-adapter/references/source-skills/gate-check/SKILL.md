...
- [ ] Technical preferences configured (`codex-studio/docs/technical-preferences.md` populated)
...
Before generating the final verdict, spawn all four directors as **parallel role passes** using the role-reference workflow using the parallel gate protocol from `codex-studio/docs/director-gates.md`. Issue all four role-reference passes simultaneously — do not wait for one before starting the next.

**Spawn in parallel:**

1. **`creative-director`** — gate **CD-PHASE-GATE** (`codex-studio/docs/director-gates.md`)
2. **`technical-director`** — gate **TD-PHASE-GATE** (`codex-studio/docs/director-gates.md`)
3. **`producer`** — gate **PR-PHASE-GATE** (`codex-studio/docs/director-gates.md`)
4. **`art-director`** — gate **AD-PHASE-GATE** (`codex-studio/docs/director-gates.md`)
...
- **No Difficulty Curve doc?** → Create `design/difficulty-curve.md` from the template at `codex-studio/docs/templates/difficulty-curve.md` — or use `/quick-design "difficulty curve"` for a guided session.
- **No player journey map?** → Create `design/player-journey.md` from the template at `codex-studio/docs/templates/player-journey.md` — or author it collaboratively using `/ux-design` Phase 2b.
