...
### Engine reference
Read `codex-studio/docs/technical-preferences.md`:
...
Read the `Engine Specialists` section of `codex-studio/docs/technical-preferences.md`
...
5. **Engine preferences**: `codex-studio/docs/technical-preferences.md` — read naming conventions and performance budgets
