...
Spawn the **primary engine specialist** in parallel (from `codex-studio/docs/technical-preferences.md` Engine Specialists) to validate the integration approach:
