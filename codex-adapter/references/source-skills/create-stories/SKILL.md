...
in this skill — apply the check pattern from `codex-studio/docs/director-gates.md`
...
After decomposing all stories (Step 4 complete) but before presenting them for write approval, load the `qa-lead` role reference and perform that role pass using gate **QL-STORY-READY** (`codex-studio/docs/director-gates.md`).
