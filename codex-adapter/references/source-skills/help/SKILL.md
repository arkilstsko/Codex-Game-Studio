...
Read `codex-studio/docs/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, Glob `codex-studio/skills/*/SKILL.md` to get the full list
