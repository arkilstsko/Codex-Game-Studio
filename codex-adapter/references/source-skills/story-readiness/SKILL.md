...
See `codex-studio/docs/director-gates.md` for the full check pattern and mode definitions.
...
Load the `qa-lead` role reference and perform that role pass using gate **QL-STORY-READY** (`codex-studio/docs/director-gates.md`).
