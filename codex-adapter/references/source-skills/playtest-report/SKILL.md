...
After categorising findings, load the `creative-director` role reference and perform that role pass using gate **CD-PLAYTEST** (`codex-studio/docs/director-gates.md`).
