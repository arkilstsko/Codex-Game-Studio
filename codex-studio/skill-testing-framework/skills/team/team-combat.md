...
- [ ] Phase 2 includes spawning the primary engine specialist (read from `codex-studio/docs/technical-preferences.md`)
...
- Engine is configured in `codex-studio/docs/technical-preferences.md` (Engine Specialists section filled)
...
**Fixture:**
- `codex-studio/docs/technical-preferences.md` has Engine Specialists section populated (e.g., Primary: godot-specialist)
...
2. Skill reads `codex-studio/docs/technical-preferences.md` Engine Specialists section to identify the primary engine specialist agent type
...
**Assertions:**
- [ ] Engine specialist agent type is read from `codex-studio/docs/technical-preferences.md` — not hardcoded
