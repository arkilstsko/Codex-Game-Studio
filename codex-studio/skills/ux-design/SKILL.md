...
> "Player journey map not yet created. Template available at `codex-studio/docs/templates/player-journey.md`. Run `/ux-design` Phase 2b or create it manually to establish player context for this screen."
...
Read `codex-studio/docs/technical-preferences.md` and extract the `## Input & Platform`
