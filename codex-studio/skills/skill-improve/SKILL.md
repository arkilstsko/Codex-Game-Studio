...
Verify `codex-studio/skills/[name]/SKILL.md` exists. If not, stop with:
...
Read the full skill file at `codex-studio/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `codex-studio/skills/[name]/SKILL.md`?"
...
Write the improved skill to `codex-studio/skills/[name]/SKILL.md`.
...
Ask: "May I revert `codex-studio/skills/[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- codex-studio/skills/[name]/SKILL.md`
