...
Before generating the Go/No-Go recommendation, load the `producer` role reference and perform that role pass using gate **PR-MILESTONE** (`codex-studio/docs/director-gates.md`).
