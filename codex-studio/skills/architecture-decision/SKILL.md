...
5.5. **Engine Specialist Validation** — Before saving, spawn the **primary engine specialist** using the role-reference workflow to validate the drafted ADR:
   - Read `codex-studio/docs/technical-preferences.md` `Engine Specialists` section to get the primary specialist
...
5.6. **Technical Director Strategic Review** — After the engine specialist validation, load the `technical-director` role reference and perform that role pass using gate **TD-ADR** (`codex-studio/docs/director-gates.md`):
