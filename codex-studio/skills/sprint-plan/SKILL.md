...
Before finalising the sprint plan, load the `producer` role reference and perform that role pass using gate **PR-SPRINT** (`codex-studio/docs/director-gates.md`).
