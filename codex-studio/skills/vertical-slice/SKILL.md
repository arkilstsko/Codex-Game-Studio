...
- Naming conventions from `codex-studio/docs/technical-preferences.md`
...
Read `codex-studio/docs/templates/vertical-slice-report.md` to get the report structure.
