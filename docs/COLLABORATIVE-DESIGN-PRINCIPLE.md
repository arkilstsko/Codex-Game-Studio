...
- **Multiple non-exclusive choices**: split into separate yes/no questions; Codex structured input is single-choice
...
Team skills (like `$ccgs-team-combat`) orchestrate multiple agents, but still collaborative:
...
This principle is embedded across the main project workflows:

- **AGENTS.md** — Collaboration protocol section added
- **All 49 role definitions** — Updated to enforce question-asking and approval
...
- **request_user_input tool** — Integrated into 16 skills for structured option UI
