...
Use the ADR template: `codex-studio/docs/templates/architecture-decision-record.md`
...
- Use `$ccgs-architecture-decision` to create ADRs through the guided flow
...
- Updated by `$ccgs-architecture-review` Phase 8

**Control Manifest:** `docs/architecture/control-manifest.md`
- Flat programmer rules sheet: Required / Forbidden / Guardrails per layer
- Date-stamped `Manifest Version:` in header
- Stories embed this version; `$ccgs-story-done` checks for staleness

**Validation:** Run `$ccgs-architecture-review` after completing a set of ADRs.
