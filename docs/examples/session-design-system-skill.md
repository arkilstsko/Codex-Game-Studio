...
**Context:** Solo indie dev, week 3 of project. `$ccgs-map-systems` already ran and produced `design/gdd/systems-index.md`. The movement system is listed as MVP tier, Foundation priority.
...
**Turns:** 14
**Outcome:** Complete `design/gdd/movement-system.md` with all 8 required sections written to file, ready for `$ccgs-design-review`
